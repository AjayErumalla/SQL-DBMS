Q1 = """CREATE TABLE User(user_id INT PRIMARY KEY NOT NULL, first_name VARCHAR(200) NOT NULL,
      last_name VARCHAR(200) NOT NULL,address VARCHAR(300), phone_number INT NOT NULL);"""
      
Q2 = """CREATE TABLE Post(user_id INT, post_id INTEGER PRIMARY KEY  AUTOINCREMENT,
